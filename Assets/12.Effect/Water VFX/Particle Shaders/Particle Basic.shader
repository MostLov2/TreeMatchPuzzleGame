	...
	Category 
	{
		...
		LOD 0
			...
			Pass {
				...
				#pragma shader_feature _ENABLETEXTURESPRITE_ON
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					#endif
					float4 temp_output_1_0_g156 = tex2DNode17;
					float2 temp_output_57_0_g156 = staticSwitch91;
					float4 tex2DNode3_g156 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g156 );
					float clampResult37_g156 = clamp( ( ( ( i.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g156.r + ( tex2D( _NoiseTexture, ( temp_output_57_0_g156 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
					float4 appendResult13_g156 = (float4(( float4( (i.color).rgb , 0.0 ) * temp_output_1_0_g156 ).rgb , ( temp_output_1_0_g156.a * pow( clampResult37_g156 , ( _CustomFadeSmoothness / max( tex2DNode3_g156.r , 0.05 ) ) ) * _CustomFadeAlpha )));
					#ifdef _ENABLECUSTOMFADE_ON
					float4 staticSwitch64 = appendResult13_g156;
					#else
					float4 staticSwitch64 = staticSwitch97;
					#endif
					float4 temp_output_1_0_g158 = staticSwitch64;
					float4 break2_g159 = temp_output_1_0_g158;
					float temp_output_3_0_g158 = ( ( break2_g159.x + break2_g159.y + break2_g159.z ) / 3.0 );
					float clampResult25_g158 = clamp( ( ( ( ( temp_output_3_0_g158 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
					float3 lerpResult6_g158 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g158);
					float temp_output_9_0_g160 = max( _SplitToningContrast , 0.0 );
					float saferPower7_g160 = max( ( temp_output_3_0_g158 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g160 ) , 0.0 ) ) ) , 0.0001 );
					float3 lerpResult11_g158 = lerp( (temp_output_1_0_g158).rgb , ( lerpResult6_g158 * pow( saferPower7_g160 , temp_output_9_0_g160 ) ) , _SplitToningFade);
					float4 appendResult18_g158 = (float4(lerpResult11_g158 , temp_output_1_0_g158.a));
					#ifdef _ENABLESPLITTONING_ON
					float4 staticSwitch93 = appendResult18_g158;
					#else
					float4 staticSwitch93 = staticSwitch64;
					#endif
					float4 temp_output_1_0_g161 = staticSwitch93;
					float3 temp_output_4_0_g161 = (temp_output_1_0_g161).rgb;
					float4 break12_g161 = temp_output_1_0_g161;
					float3 lerpResult7_g161 = lerp( temp_output_4_0_g161 , ( temp_output_4_0_g161 + (_BlackTintColor).rgb ) , pow( ( 1.0 - min( max( max( break12_g161.r , break12_g161.g ) , break12_g161.b ) , 1.0 ) ) , max( _BlackTintPower , 0.001 ) ));
					float3 lerpResult13_g161 = lerp( temp_output_4_0_g161 , lerpResult7_g161 , _BlackTintFade);
					float4 appendResult11_g161 = (float4(lerpResult13_g161 , break12_g161.a));
					#ifdef _ENABLEBLACKTINT_ON
					float4 staticSwitch79 = appendResult11_g161;
					#else
					float4 staticSwitch79 = staticSwitch93;
					#endif
					float4 temp_output_1_0_g162 = staticSwitch79;
					float saferPower11_g162 = max( ( 1.0 - temp_output_1_0_g162.a ) , 0.0001 );
					float3 lerpResult4_g162 = lerp( (temp_output_1_0_g162).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g162 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g162.a ) ));
					float4 appendResult13_g162 = (float4(lerpResult4_g162 , temp_output_1_0_g162.a));
					#ifdef _ENABLEALPHATINT_ON
					float4 staticSwitch86 = appendResult13_g162;
					#else
					float4 staticSwitch86 = staticSwitch79;
					#endif
					float4 break2_g163 = staticSwitch86;
					float3 appendResult4_g163 = (float3(break2_g163.r , break2_g163.g , break2_g163.b));
					float3 hsvTorgb16_g163 = RGBToHSV( appendResult4_g163 );
					float clampResult18_g163 = clamp( ( hsvTorgb16_g163.y * _AdjustColorSaturation ) , 0.0 , 1.0 );
					float temp_output_9_0_g164 = max( _AdjustColorContrast , 0.0 );
					float saferPower7_g164 = max( ( hsvTorgb16_g163.z + ( 0.1 * max( ( 1.0 - temp_output_9_0_g164 ) , 0.0 ) ) ) , 0.0001 );
					float3 hsvTorgb24_g163 = HSVToRGB( float3(( hsvTorgb16_g163.x + _AdjustColorHueShift ),clampResult18_g163,( pow( saferPower7_g164 , temp_output_9_0_g164 ) * _AdjustColorBrightness )) );
					float3 lerpResult9_g163 = lerp( appendResult4_g163 , hsvTorgb24_g163 , _AdjustColorFade);
					float4 appendResult3_g163 = (float4(lerpResult9_g163 , break2_g163.a));
					#ifdef _ENABLEADJUSTCOLOR_ON
					float4 staticSwitch84 = appendResult3_g163;
					#else
...
/*ASEBEGIN
Version=18909
119;359;1722;1081;2304.912;1124.911;1.937534;True;False
...
Node;AmplifyShaderEditor.FunctionNode;78;-1098.72,-294.451;Inherit;False;TintVertex;-1;;155;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;90;-1154.998,126.8534;Inherit;False;_CustomFade;9;;156;09a17a2b3ff778e4baeae7d542f88dd6;0;3;57;FLOAT2;0,0;False;56;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;94;-101.8765,-215.0642;Inherit;False;_SplitToning;17;;158;6b87c8196f94bcd478491aaa714b31ef;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;81;746.9941,-187.6142;Inherit;False;_BlackTint;25;;161;e72823b8923579647a619869b654ace9;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;85;1573.545,-214.9836;Inherit;False;_AlphaTint;30;;162;ae9f8d24855c66643be02b2aa90f050e;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;86;1907.981,-348.1771;Inherit;False;Property;_EnableAlphaTint;Enable Alpha Tint;29;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;82;2407.541,-244.2802;Inherit;False;_AdjustColor;2;;163;e7083192d13fe334cab64b3d59374f2b;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=4D3C5C61F5373C18D4882A20838AF2E9C742932F